...
int main()
{
	...
	try
	{
		do
		{
			...
			{
			case 1: /*Ñîçäàíèå îäíîòèïíûõ ÁÄ è ãèáðèäíûõ ÁÄ.*/
			{
				std::string DB_name;
			...
			case 2: /*Âûâîä íà ýêðàí ñïèñêà ñóùåñòâóþùèõ ÁÄ.*/
			{
				std::cout << std::endl;
			...
			case 7: /*Äîáàâëåíèå çàïèñåé â ÁÄ.*/
			{
				if (file.is_open())
				{
					std::string plan;
			...
			case 9: /*Âûâîä íà ýêðàí çàïèñåé ÁÄ.*/
			{
				if (file.is_open())
				{
			...
			case 11: /*Âûáîðêà çàïèñåé ÁÄ ïî ïðàâèëó (ïîäìíîæåñòâî çàïèñåé).*/
			{
				if (file.is_open())
				{
					std::string cmnd;
			...
			case 12: /*Ñîõðàíåíèå âûáîðêè êàê íîâîé ÁÄ (ïî æåëàíèþ ïîëüçîâàòåëÿ).*/
			{
				if (DB_subset.size() > 0)
				{
			...
			case 13: /*Ðåäàêòèðîâàíèå çàïèñåé â ÁÄ.*/
			{
				if (file.is_open())
				{
					for (auto& i : DB)
			...
			case 14: /*Ïîäñ÷åò êîëè÷åñòâà îòëè÷íèêîâ*/
			{
				if (file.is_open())
				{
					read(file, DB);
